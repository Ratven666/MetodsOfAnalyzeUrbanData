...
class WindDBService:
    """
    Сервис для чтения данных wind_points и wind_measurements через raw SQL.
    Используется legacy-маршрутами и DependencyContainer.
    Для полного CRUD используйте wind_points/crud.py + get_db().
    """
