...
class WindMeasurement(Base):
    ...
    wind_point_id: Mapped[int] = mapped_column(ForeignKey("wind_points.id", ondelete="CASCADE"), nullable=False)
    ...
    point: Mapped[WindPoint] = relationship(back_populates="measurements")
